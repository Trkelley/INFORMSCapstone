<!-- This is the authentication file that will take care of all the back-end database functions involved with the Login page. -->

<!-- CREATE ACCOUNT back-end functions could also be performed in this file. -->

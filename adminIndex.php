    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content modal-lg">
            <div class="modal-header modal-lg">
                ...
                <h4 class="modal-title" id="programModalLabel">Program Detail</h4>
            </div>
            <div class="dash">
...
<div class="container">
	<div class="row">
        <div class="col-lg-12">
            <p class="text-center" class="page-header"> <font size="5">Hello (Informs Admin)! </font></p>
            <p class="text-center" class="page-header"><font size="4">Information on the following programs has been modified; ready for review</font></p>
            <p class = "text-center" class="page-header"> <font size="3">  To view the updated program please choose View Program Info</font></p>
